...
#id placement
input_window = my_canvas.create_window(red_offset - 175, 250, window=r_id[0])
input_window = my_canvas.create_window(red_offset - 175, 285, window=r_id[1])
input_window = my_canvas.create_window(red_offset - 175, 320, window=r_id[2])
input_window = my_canvas.create_window(red_offset - 175, 355, window=r_id[3])
input_window = my_canvas.create_window(red_offset - 175, 390, window=r_id[4])
input_window = my_canvas.create_window(red_offset - 175, 425, window=r_id[5])
input_window = my_canvas.create_window(red_offset - 175, 460, window=r_id[6])
input_window = my_canvas.create_window(red_offset - 175, 495, window=r_id[7])
input_window = my_canvas.create_window(red_offset - 175, 530, window=r_id[8])
input_window = my_canvas.create_window(red_offset - 175, 565, window=r_id[9])
input_window = my_canvas.create_window(red_offset - 175, 600, window=r_id[10])
input_window = my_canvas.create_window(red_offset - 175, 635, window=r_id[11])
input_window = my_canvas.create_window(red_offset - 175, 670, window=r_id[12])
input_window = my_canvas.create_window(red_offset - 175, 705, window=r_id[13])
input_window = my_canvas.create_window(red_offset - 175, 740, window=r_id[14])
...
#placement id
input_window = my_canvas.create_window(green_offset - 175, 250, window=g_id[0])
input_window = my_canvas.create_window(green_offset - 175, 285, window=g_id[1])
input_window = my_canvas.create_window(green_offset - 175, 320, window=g_id[2])
input_window = my_canvas.create_window(green_offset - 175, 355, window=g_id[3])
input_window = my_canvas.create_window(green_offset - 175, 390, window=g_id[4])
input_window = my_canvas.create_window(green_offset - 175, 425, window=g_id[5])
input_window = my_canvas.create_window(green_offset - 175, 460, window=g_id[6])
input_window = my_canvas.create_window(green_offset - 175, 495, window=g_id[7])
input_window = my_canvas.create_window(green_offset - 175, 530, window=g_id[8])
input_window = my_canvas.create_window(green_offset - 175, 565, window=g_id[9])
input_window = my_canvas.create_window(green_offset - 175, 600, window=g_id[10])
input_window = my_canvas.create_window(green_offset - 175, 635, window=g_id[11])
input_window = my_canvas.create_window(green_offset - 175, 670, window=g_id[12])
input_window = my_canvas.create_window(green_offset - 175, 705, window=g_id[13])
input_window = my_canvas.create_window(green_offset - 175, 740, window=g_id[14])
