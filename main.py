...
def player_entry():
    ...
    #red team names
    red[0] = Entry(my_canvas, width=30)
    red[1] = Entry(my_canvas, width=30)
    red[2] = Entry(my_canvas, width=30)
    red[3] = Entry(my_canvas, width=30)
    red[4] = Entry(my_canvas, width=30)
    red[5] = Entry(my_canvas, width=30)
    red[6] = Entry(my_canvas, width=30)
    red[7] = Entry(my_canvas, width=30)
    red[8] = Entry(my_canvas, width=30)
    red[9] = Entry(my_canvas, width=30)
    red[10] = Entry(my_canvas, width=30)
    red[11] = Entry(my_canvas, width=30)
    red[12] = Entry(my_canvas, width=30)
    red[13] = Entry(my_canvas, width=30)
    red[14] = Entry(my_canvas, width=30)
